...
<td><input type="text" inputmode="numeric" value="${n(it.total)}" onblur="editGoal('${g.month}',${idx},'total',this.value)" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur()}"></td>
<td><input type="text" inputmode="numeric" value="${n(it.undb)}" onblur="editGoal('${g.month}',${idx},'undb',this.value)" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur()}"></td>
<td><input type="text" inputmode="numeric" value="${n(it.db)}" onblur="editGoal('${g.month}',${idx},'db',this.value)" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur()}"></td>
<td><input type="text" inputmode="numeric" value="${n(it.pos)}" onblur="editGoal('${g.month}',${idx},'pos',this.value)" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur()}"></td>
